...
const development = {
    ...
    accessTokenSecret: process.env.DEVELOPMENT_ACCESS_TOKEN_SECRET,
    accessTokenExpiresIn: process.env.ACCESS_TOKEN_EXPIRES_IN || "15s",
    refreshTokenSecret: process.env.DEVELOPMENT_REFRESH_TOKEN_SECRET,
...
const test = {
    ...
    accessTokenName: process.env.APP_NAME ? process.env.APP_NAME + "_ACCESS_TOKEN" : "ACCESS_TOKEN",
    refreshTokenName: process.env.APP_NAME ? process.env.APP_NAME + "_REFRESH_TOKEN" : "REFRESH_TOKEN",
    accessTokenSecret: process.env.TEST_ACCESS_TOKEN_SECRET,
    accessTokenExpiresIn: process.env.ACCESS_TOKEN_EXPIRES_IN || "15s",
    refreshTokenSecret: process.env.TEST_REFRESH_TOKEN_SECRET,
    refreshTokenExpiresIn: process.env.REFRESH_TOKEN_EXPIRES_IN || "30d",
